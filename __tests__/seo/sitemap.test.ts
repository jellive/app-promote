...
describe("Sitemap Generation", () => {
  ...
  describe("Total Entries", () => {
    it("should have correct total count (2 static + 30 projects)", () => {
      expect(sitemapResult).toHaveLength(32);
    });
  });
});
