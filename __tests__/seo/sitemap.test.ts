...
describe("Sitemap Generation", () => {
  ...
  describe("Total Entries", () => {
    it("should have correct total count (2 static + 18 projects)", () => {
      expect(sitemapResult).toHaveLength(20);
    });
  });
});
